...
proc sql;
  ...
  from tmpdsn.dd3(keep=lopnr diag diag_dat npr_source icd rename=(lopnr=lopnr_mor)) as a
  inner join tmpdsn.mbr1 as b
...
proc sql;
  create table t3
  as select b.lopnr_barn, a.*
  from tmpdsn.dd3(keep=lopnr diag diag_dat npr_source icd rename=(lopnr=lopnr_far)) as a
  inner join tmpdsn.mbr1 as b
